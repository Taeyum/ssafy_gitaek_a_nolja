...
<template>
  <div
    class="min-h-screen bg-white font-sans overflow-x-hidden selection:bg-[#DE2E5F] selection:text-white"
  >
    <header
      class="fixed w-full top-0 z-50 bg-white/70 backdrop-blur-lg border-b border-gray-100 transition-all"
    >
      <div
      ...
      >
        ...
        >
          <div
            class="w-8 h-8 rounded-xl bg-gradient-to-tr from-[#DE2E5F] to-[#ff5d8d] flex items-center justify-center shadow-lg shadow-pink-200"
          >
            <MapPin class="h-4 w-4 text-white" />
          </div>
          <h1 class="text-xl font-extrabold tracking-tight text-gray-900">
            Gitaek <span class="text-[#DE2E5F]">Anolja</span>
          </h1>
        </div>
        ...
        <nav class="flex items-center gap-4">
          ...
          <template v-if="!userStore.isLoggedIn">
            <button
              ...
              class="text-sm font-semibold text-gray-500 hover:text-[#DE2E5F] transition-colors"
            >
              로그인
            </button>
            <button
              @click="openAuthModal('signup')"
              class="px-5 py-2 bg-[#DE2E5F] text-white text-sm font-bold rounded-full hover:bg-[#c92552] shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
            >
              회원가입
            </button>
          </template>
          <template v-else>
            <div
              @click="emit('my-page')"
              class="flex items-center gap-2 cursor-pointer p-1 pr-3 rounded-full hover:bg-gray-100 transition-all border border-transparent hover:border-gray-200"
            >
              <img
                :src="
    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      <div class="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10">
        <div
          class="absolute top-0 left-1/4 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"
        ></div>
        <div
        ...
        ></div>
        <div
          class="absolute -bottom-8 left-1/3 w-72 h-72 bg-yellow-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"
        ></div>
      </div>

      <div
        class="absolute top-1/4 left-[10%] animate-float-slow hidden lg:block"
      >
      ...
      <div
        class="absolute bottom-1/4 right-[10%] animate-float hidden lg:block"
      >
      ...
      <div
        class="absolute top-1/3 right-[15%] animate-float-fast hidden lg:block"
      >
        <div class="bg-white p-3 rounded-2xl shadow-xl rotate-[6deg]">
      ...
      <div
        class="container mx-auto px-6 text-center relative z-10 flex flex-col items-center"
      >
        <div
          class="inline-block mb-4 px-4 py-1.5 rounded-full bg-pink-50 border border-pink-100 text-[#DE2E5F] font-bold text-sm shadow-sm animate-fade-in-up"
        >
          🚀 친구들과 함께 떠나는 국내 여행
        </div>
        <h2
          class="text-5xl lg:text-7xl font-black text-gray-900 leading-tight mb-6 animate-fade-in-up delay-100"
        >
          여행 계획, 더 이상<br />
          <span
            class="text-transparent bg-clip-text bg-gradient-to-r from-[#DE2E5F] to-[#FF6B6B]"
            >혼자 고민하지 마세요</span
          >
        </h2>
        <p
          class="text-xl text-gray-500 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200"
        >
          실시간으로 친구들과 지도를 보며 동선을 짜고,<br
        ...
        <div
          class="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up delay-300 w-full max-w-lg"
        >
          <button
    ...
    <section class="container mx-auto px-6 py-24">
      <div class="text-center mb-16">
        ...
        <p class="text-gray-500">
          복잡한 여행 계획, 이제 쉽고 재미있게 해결하세요.
        </p>
      </div>

      <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <div
          class="group bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
        >
          <div
            class="w-14 h-14 rounded-2xl bg-pink-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"
          >
        ...
        >
          <div
            class="w-14 h-14 rounded-2xl bg-orange-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"
          >
        ...
        >
          <div
            class="w-14 h-14 rounded-2xl bg-purple-50 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"
          >
    ...
    <section class="container mx-auto px-6 py-20">
      <div
        class="relative overflow-hidden rounded-[3rem] bg-gray-900 text-white p-12 lg:p-20 text-center"
      >
        <div
          class="absolute top-0 right-0 w-64 h-64 bg-[#DE2E5F] rounded-full mix-blend-overlay filter blur-3xl opacity-20"
        ></div>
        <div
        ...
        <div class="relative z-10 max-w-2xl mx-auto">
          <h2 class="text-3xl md:text-5xl font-bold mb-6">
            여행 준비, <br />지금 바로 시작해보세요.
          </h2>
          <p class="text-gray-400 mb-10 text-lg">
            별도의 설치 없이 웹에서 바로 시작할 수 있습니다.<br />친구들을
            초대하고 즐거운 계획을 세워보세요.
          </p>
          <button
            @click="showCreateModal = true"
    ...
    <footer class="bg-white border-t border-gray-100 pt-16 pb-8">
      <div class="container mx-auto px-6">
        <div
          class="flex flex-col md:flex-row justify-between items-start mb-12 gap-8"
        >
          <div>
            <div class="flex items-center gap-2 mb-4">
              <div
                class="w-8 h-8 rounded-lg bg-[#DE2E5F] flex items-center justify-center"
              >
                <MapPin class="h-4 w-4 text-white" />
              </div>
          ...
          <div class="flex gap-12">
            <div>
              ...
              <ul class="space-y-2 text-sm text-gray-500">
                ...
                <li>
                  <a href="#" class="hover:text-[#DE2E5F]">자주 묻는 질문</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        >
          <p class="text-sm text-gray-400">
            &copy; 2025 Gitaek Anolja. All rights reserved.
          </p>
          <div class="flex gap-4">
            <Github
              class="w-5 h-5 text-gray-400 hover:text-gray-900 cursor-pointer"
            />
            <Twitter
              class="w-5 h-5 text-gray-400 hover:text-blue-400 cursor-pointer"
            />
            <Instagram
              class="w-5 h-5 text-gray-400 hover:text-pink-500 cursor-pointer"
            />
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div
        class="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden p-8 space-y-6 transform transition-all scale-100"
      >
        <div class="flex items-center justify-between">
          <h3 class="text-2xl font-bold text-gray-900">여행 정보 입력</h3>
          <button
            @click="showCreateModal = false"
            class="text-gray-400 hover:text-gray-600 bg-gray-100 p-2 rounded-full transition-colors"
          >
            <X class="w-5 h-5" />
          </button>
        </div>
        ...
        <div class="space-y-6">
          <div class="space-y-2">
            ...
            <input
              ...
              class="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:border-[#DE2E5F] focus:ring-1 focus:ring-[#DE2E5F] transition-all"
            />
          </div>
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center gap-3">
              <button
                @click="members > 1 && members--"
                class="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-xl font-bold hover:bg-gray-200"
              >
                -
              </button>
